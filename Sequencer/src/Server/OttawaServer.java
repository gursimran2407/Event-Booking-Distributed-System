...
//import static Server.MontrealServer.i;
import static Server.MontrealServer.isFT2;
...
//                }
            ...
            case "FT":
                ...
                System.out.println("Server.OttawaServer.replicaManagerImpl() CommonUtils.isFT set to::" + CommonUtils.isFT);
                response = "FT";
                break;
